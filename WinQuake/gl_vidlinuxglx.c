...
#define X_MASK                                                                 \
  (KEY_MASK | MOUSE_MASK | VisibilityChangeMask | StructureNotifyMask)
...
static void install_grabs(void) {
  ...
  XGrabPointer(dpy, win, True, 0, GrabModeAsync, GrabModeAsync, win, None,
               CurrentTime);
...
void Sys_SendKeyEvents(void) { HandleEvents(); }
