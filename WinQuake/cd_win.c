...
static int CDAudio_GetAudioDiskInfo(void) {
  ...
  dwReturn = mciSendCommand(wDeviceID, MCI_STATUS, MCI_STATUS_ITEM | MCI_WAIT,
...
void CDAudio_Play(byte track, qboolean looping) {
  ...
  dwReturn = mciSendCommand(wDeviceID, MCI_PLAY, MCI_NOTIFY | MCI_FROM | MCI_TO,
...
int CDAudio_Init(void) {
  ...
  if (dwReturn = mciSendCommand(0, MCI_OPEN, MCI_OPEN_TYPE | MCI_OPEN_SHAREABLE,
