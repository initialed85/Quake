...
typedef struct vmode_s {
  ...
  void (*begindirectrect)(viddef_t *vid, struct vmode_s *pcurrentmode, int x,
                          int y, byte *pbitmap, int width, int height);
  void (*enddirectrect)(viddef_t *vid, struct vmode_s *pcurrentmode, int x,
...
void VGA_SwapBuffersCopy(viddef_t *vid, vmode_t *pcurrentmode, vrect_t *rects);
...
void VGA_EndDirectRect(viddef_t *vid, struct vmode_s *pcurrentmode, int x,
                       int y, int width, int height);
void VGA_UpdateLinearScreen(void *srcptr, void *destptr, int width, int height,
