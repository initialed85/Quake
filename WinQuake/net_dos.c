...
net_driver_t net_drivers[MAX_NET_DRIVERS] = {
    ...
    {"Serial", false, Serial_Init, Serial_Listen, Serial_SearchForHosts,
     Serial_Connect, Serial_CheckNewConnections, Serial_GetMessage,
     Serial_SendMessage, Serial_SendUnreliableMessage, Serial_CanSendMessage,
     Serial_CanSendUnreliableMessage, Serial_Close, Serial_Shutdown}};
...
net_landriver_t net_landrivers[MAX_NET_DRIVERS] = {{"Beame & Whiteside TCP/IP",
                                                    false,
                                                    0,
                                                    BW_Init,
                                                    BW_Shutdown,
