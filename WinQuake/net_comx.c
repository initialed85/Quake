...
static void COM1_ISR_8250(void) { ISR_8250(handleToPort[0]); }

static void COM2_ISR_8250(void) { ISR_8250(handleToPort[1]); }
...
static void COM1_ISR_16550(void) { ISR_16550(handleToPort[0]); }

static void COM2_ISR_16550(void) { ISR_16550(handleToPort[1]); }

void TTY_GetComPortConfig(int portNumber, int *port, int *irq, int *baud,
                          qboolean *useModem) {
  ComPort *p;
...
void TTY_SetComPortConfig(int portNumber, int port, int irq, int baud,
                          qboolean useModem) {
  ComPort *p;
  float temp;
...
void TTY_GetModemConfig(int portNumber, char *dialType, char *clear, char *init,
                        char *hangup) {
  ComPort *p;
...
void TTY_SetModemConfig(int portNumber, char *dialType, char *clear, char *init,
                        char *hangup) {
  ComPort *p;
...
int TTY_Open(int serialPortNumber) { return serialPortNumber; }
