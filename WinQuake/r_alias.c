...
void R_AliasSetupSkin(void) {
  ...
  pskindesc =
      ((maliasskindesc_t *)((byte *)paliashdr + paliashdr->skindesc)) + skinnum;
  ...
  if (pskindesc->type == ALIAS_SKIN_GROUP) {
    ...
    skintargettime =
        skintime - ((int)(skintime / fullskininterval)) * fullskininterval;
...
void R_AliasDrawModel(alight_t *plighting) {
  ...
  // cache align
  pfinalverts = (finalvert_t *)(((long)&finalverts[0] + CACHE_SIZE - 1) &
                                ~(CACHE_SIZE - 1));
