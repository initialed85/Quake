...
enum _ControlList { AxisNada = 0, AxisForward, AxisLook, AxisSide, AxisTurn };

DWORD dwAxisFlags[JOY_MAX_AXES] = {JOY_RETURNX, JOY_RETURNY, JOY_RETURNZ,
...
qboolean IN_ReadJoystick(void) {
  ...
  if (joyGetPosEx(joy_id, &ji) == JOYERR_NOERROR) {
    ...
    // DirectInput Driver rather than having 32768 be the zero point, they have
    // the zero point at 32668 go figure -- anyway, now we get the full
    // resolution out of the device
