...
RUN cp -frv /srv/WinQuake/build-linux/libSDL2-2.0d.so.0.3200.4 /usr/local/lib/libSDL2-2.0d.so.0.3200.4

RUN ln -s /usr/bin/llvm-symbolizer-19 /usr/bin/llvm-symbolizer

ENTRYPOINT ["/srv/WinQuake/build-linux/Quake", "-dedicated", "16"]
