...
RUN test -e /srv/WinQuake/build-linux/libSDL2-2.0.so.0.3200.4 && cp -frv /srv/WinQuake/build-linux/libSDL2-2.0.so.0.3200.4 /usr/local/lib/libSDL2-2.0.so.0.3200.4
